...
!=======================================================================
     ...
     SUBROUTINE system_bcast()
       ...
       CALL mp_bcast( lgate_screen,      ionode_id, intra_image_comm )
       CALL mp_bcast( dgate,             ionode_id, intra_image_comm )
     ...
     SUBROUTINE electrons_bcast()
       ...
       IMPLICIT NONE
       !
       CALL mp_bcast( write_exx_restart,    ionode_id, intra_image_comm )
